...
{
	public class PrintServer : HostedServiceTemplate
	{
		...
		private bool PrintLabel(PhysicalPrinter physicalPrinter, LabelCreatedEventArgs labelCreatedEventArgs)
		{
			bool returnValue = false;
		...
		private float X(PhysicalPrinter physicalPrinter, int pageWidth, float imageWidth, float scaleX)
		{
			float returnValue = 0;
		...
		private float Y(PhysicalPrinter physicalPrinter, int pageHeight, float imageHeight, float scaleY)
		{
			float returnValue = 0;
