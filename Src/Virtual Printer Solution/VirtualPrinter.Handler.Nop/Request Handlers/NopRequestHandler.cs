...
namespace VirtualPrinter.Handler.Nop
{
	internal class NopRequestHandler(ILogger<NopRequestHandler> logger, IEventAggregator eventAggregator, ILabelService labelService, IImageCacheRepository imageCacheRepository) : TemplateRequestHandler(logger, eventAggregator, labelService, imageCacheRepository)
	{
