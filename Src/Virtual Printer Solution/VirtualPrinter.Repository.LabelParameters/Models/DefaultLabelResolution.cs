...
{
	public class DefaultLabelResolution : Entity, IResolution
	{
		...
		public int Dpmm { get => DefaultPrinterConfiguration.Instance.ResolutionInDpmm; set => throw new ReadOnlyException(); }
	}
}