...
{
	public class ResolutionRepository : DisposableObject, IReadOnlyRepository<IResolution>
	{
		...
		protected IList<IResolution> Items { get; } = [];
		public string Name { get; set; }

		public Task<IEnumerable<IResolution>> GetAllAsync()
		{
			return Task.FromResult<IEnumerable<IResolution>>(this.Items);
		}
		...
		public Task<IEnumerable<IResolution>> GetAsync(IRepositoryContext context, Expression<Func<IResolution, bool>> predicate) => throw new NotImplementedException();
	}
}
